...
static const char qt_meta_stringdata_ImageCanvas[] = {
    "ImageCanvas\0\0SaveImage()\0value\0"
    "ShowProgress(int)\0"
};
...
void ImageCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ShowProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ImageCanvas::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ImageCanvas::staticMetaObject = {
    { &QgsMapCanvas::staticMetaObject, qt_meta_stringdata_ImageCanvas,
      qt_meta_data_ImageCanvas, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ImageCanvas::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageCanvas))
